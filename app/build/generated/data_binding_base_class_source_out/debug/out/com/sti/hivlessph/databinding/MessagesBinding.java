...
public final class MessagesBinding implements ViewBinding {
  ...
  private MessagesBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textMessage,
      @NonNull TextView textSender, @NonNull TextView textTimestamp) {
  ...
  public static MessagesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MessagesBinding((ConstraintLayout) rootView, textMessage, textSender,
          textTimestamp);
    }
