...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton buttonChat, @NonNull ConstraintLayout container,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.button_chat;
      FloatingActionButton buttonChat = ViewBindings.findChildViewById(rootView, id);
      if (buttonChat == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, buttonChat, container, navView);
    }
